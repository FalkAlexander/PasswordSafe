...
ATTRIBUTE_HOST_PATH = "user.document-portal.host-path"
...
def get_host_path(gfile: Gio.File) -> str | None:
    ...
    try:
        attr = os.getxattr(local_path, ATTRIBUTE_HOST_PATH)
    except OSError:
        return local_path
    else:
        return os.fsdecode(attr)
